...
def main() -> None:
    ...
    pre_load = torch.load('./checkpoints_hierarchical/policy_update_00012.pt',
    ...
    # ── Outer update loop ────────────────────────────────────────────────────── CHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAANGE START HERE
    outer_bar = tqdm(range(13, cfg.n_updates), desc="Updates", unit="upd")
